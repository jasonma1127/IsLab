...
yLabel = np.append(malware_label, benign_label)

# xData = np.append(np.array(malware_OPG_NDH), np.array(benign_OPG_NDH), axis = 0)
xData = np.vstack(totalsFeatureDf["feature"])
...
# save model
joblib.dump(clf, "opcodeGraph_model")
